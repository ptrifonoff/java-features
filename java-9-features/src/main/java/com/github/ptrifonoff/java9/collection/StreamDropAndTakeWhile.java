...
public class StreamDropAndTakeWhile {
    ...
    public static void main(String[] args) {
        ...
        // TODO Stream.takeWhile: stops iteration of stream as soon as takeWhile predicate evaluates to false; the or-condition (number >= 13) in the sample below does not have any effect
        System.out.println(
        ...
        // TODO Stream.dropWhile: starts iteration of stream as soon as dropWhile predicate evaluates to true; the number >= 13 does not have any effect
        System.out.println(
